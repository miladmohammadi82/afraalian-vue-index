                        ...
                        <div class="">
                            <form @submit.prevent="editArticle">
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <input type="text" v-model="article.name" class="mt-2 form-control  "
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <input type="text" v-model="article.slug" class="mt-2 form-control "
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <input type="text" v-model="article.hit" class="mt-2 form-control "
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <select class="chosen-select form-control" v-model="article.categories" placeholder="دسته بندی را انتخاب کنید" name="categories[]" multiple>
                                ...
                                <div class="input-fild-box form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" v-model="article.index_image" class="form-control" type="text" name="index_image">
                                    </div>
...
export default {
    ...
    methods: {
        ...
        getEmployeeArticle(){
            apiAdmin.getEmployeeArticle(this.$route.params.id)
            .then((response) => {
